...
import { ArrowRight, Loader2, CheckCircle, RefreshCcw, Sparkles } from "lucide-react";
...
export default function TaskAssessment() {
  ...
  const handleSubmitEmail = (e: React.FormEvent) => {
    e.preventDefault();
    if (email) {
      // TODO: Save to database/email service
      setSubmitted(true);
    }
  };
  ...
  return (
    <section id="assessment" className="py-24 lg:py-32 px-6 lg:px-8 bg-gradient-to-b from-[#0a0a0f] via-[#0f0f1a] to-[#0a0a0f]">
...
• Research competitors every Monday"
                    className="w-full h-48 px-4 py-4 rounded-xl bg-[#0a0a0f] border border-[#27272a] text-white placeholder:text-[#9ca3af] focus:border-[#00d4ff] focus:outline-none transition-colors duration-200 resize-none"
                  />
                </div>
                ...
                <div className="flex items-center gap-2 text-sm text-[#9ca3af]">
                  ...
                  <span>Include time estimates for better accuracy (e.g., &quot;2 hours/day&quot;)</span>
                </div>
